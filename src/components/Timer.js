...
export default function Timer() {
  return (
    <div className=" flex items-center justify-center  my-4 sm:my-10">
      <div className="py-8 flex text-center sm:text-start w-full sm:w-2/4 flex-col bg-[#EEF0F4] dark:bg-gray-500 dark:text-white items-center justify-evenly	 sm:flex-row">
        <div>
